...
list(
  ...
  # 
  # # FIA database
  # tar_target(FIA_data_tree, get_FIA_data_CR()),
  # tar_target(FIA_data_plot, merge_FIA_tree_plot(FIA_data_tree)),
  # tar_target(FIA_data = get_FIA_coord(FIA_data_plot)),
  # 
  # # Spanish NFI data
  ...
  ### 5. Running models to explore allometry relationships using nlme
  
  tar_target(outputs_height_nlme, height_models_nlme()),
  tar_target(outputs_diameter_nlme, diameter_models_nlme()),
  tar_target(outputs_depth_nlme, depth_models_nlme()),
  tar_target(outputs_depth_height_nlme, depth_height_models_nlme()))
