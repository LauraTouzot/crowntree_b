depth_height_models_nlme <- function (sp) {
  ...
  write.csv(file = paste0("output/depthheight_linear_alldata__nlme.",sp,".csv"), parameters_linear_1)
  write.csv(file = paste0("output/depthheight_linear_resampling__nlme.",sp,".csv"), parameters_linear_2)
