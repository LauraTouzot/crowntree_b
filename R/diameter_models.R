...
diameter_resampling_c1 <- function(diameter_data, diameter_species) {
...
diameter_resampling_c1_log <- function(diameter_data, diameter_species) {
...
diameter_resampling_c2 <- function(diameter_data, diameter_species) {
...
diameter_resampling_c2_log <- function(diameter_data, diameter_species) {
